...
const Dashboard = () => {
  ...
  // 🧠 Ubah title tab berdasarkan menu aktif
  useEffect(() => {
    const titles = {
      dashboard: "Dashboard",
      product: "Product RPL",
    ...
    const currentTitle = titles[menu] || "Admin PPLG";
    document.title = `${currentTitle} | Admin PPLG`;
  }, [menu]);

  // Simpan menu terakhir ke localStorage
  useEffect(() => {
